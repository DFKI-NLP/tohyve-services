...
def send_sentence(sentence, source_language_code, target_language_code):
    url = "https://dfki-3109.dfki.de/mt/run/predict"
...
if language_code == "en":
    ...
    for sentence in en_sentences:
        total_processing_time += send_sentence(sentence, "en", "de")
    average_time = total_processing_time/len(en_sentences)
elif language_code == "de":
    for sentence in de_sentences:
        total_processing_time += send_sentence(sentence, "de", "en")
...
"""
For above sentences, average processing time for a single sentence is:
    German: 0.37 secs (approx)
    English: 0.233 secs (approx)
